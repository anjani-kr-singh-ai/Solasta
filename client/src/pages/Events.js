...
const Events = () => {
  ...
  const events = [
    ...
    // },
    {
      ...
      description: "Will your bot be the one who clears the maze the fastest. Time to put your maze solving algos onto test.",
    },
    {
      _id: 19,
    ...
    },
    {
      ...
      img: "gdg.png",
      category: "Technical Events",
      description: "Hackathon by Google Developer Groups with exciting prizes",
    },
